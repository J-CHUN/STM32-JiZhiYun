...
* @{
*/
#define PRODUCT_KEY "b51c61889a5348a9b1ee320b11f74423"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "fc20095da9394b5597acf80691d4490a"
...
* @{
*/
#define LEDSwitch_BYTEOFFSET                    0
#define LEDSwitch_BITOFFSET                     0
#define LEDSwitch_LEN                           1

#define Light_RATIO                         0.1
#define Light_ADDITION                      0
#define Light_MIN                           0
#define Light_MAX                           100000
/**@} */
